...
# save up to 100,000 lines in history. oh-my-zsh default is 10,000
SAVEHIST=100000
...
mem() {
  ps -eo rss,pid,euser,args:100 --sort %mem | grep -v grep | grep -i $@ | awk '{printf $1/1024 "MB"; $1=""; print; printf "\n" }'
}
